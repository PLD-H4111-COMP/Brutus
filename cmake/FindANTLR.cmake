...
if(NOT ANTLR_EXECUTABLE AND NOT ANTLR_EXECUTABLE_BIN)
  find_program(ANTLR_EXECUTABLE
               NAMES antlr.jar antlr4.jar antlr-4.jar antlr-4.7.2-complete.jar)

  if (NOT ANTLR_EXECUTABLE)
    find_program(ANTLR_EXECUTABLE_BIN
                 NAMES antlr4)
  endif()
endif()

if((ANTLR_EXECUTABLE AND Java_JAVA_EXECUTABLE) OR ANTLR_EXECUTABLE_BIN)
  if (ANTLR_EXECUTABLE_BIN)
    set(ANTLR_COMMAND ${ANTLR_EXECUTABLE_BIN})
  else()
    set(ANTLR_COMMAND ${Java_JAVA_EXECUTABLE} -jar ${ANTLR_EXECUTABLE})
  endif()
...
endif((ANTLR_EXECUTABLE AND Java_JAVA_EXECUTABLE) OR ANTLR_EXECUTABLE_BIN)

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(
    ANTLR
    REQUIRED_VARS ANTLR_COMMAND Java_JAVA_EXECUTABLE
